   ...
   <div className="flex flex-1 flex-col items-center justify-between px-5 pb-5 pt-2">
    ...
    <div className="relative mt-2 w-[54%] rounded-3xl bg-white p-1.5 shadow-[0_12px_36px_rgba(0,0,0,0.42)]">
     ...
     <div className="flex items-center justify-center gap-1 py-1.25">
      ...
      <div className="h-1 w-5.5 rounded-full bg-gray-300" />
      <div className="h-1.25 w-1.25 rounded-full bg-gray-400" />
     </div>
     ...
     <div className="overflow-hidden rounded-[10px] bg-black">
      ...
      <div className="flex items-center justify-between bg-[#3b5998] px-2 py-0.5 text-[6px] text-white">
       <div className="flex items-center gap-0.5">
        <svg
         viewBox="0 0 16 10"
         className="h-1.25 w-2 fill-white"
        >
         <rect
          x="0"
          y="6"
      ...
      <div className="flex items-center gap-1 bg-[#3b5998] px-1.5 pb-0.75 pt-0.5">
       <svg
        viewBox="0 0 24 24"
        className="h-2.5 w-2.5 shrink-0 fill-white"
       >
       ...
       <div className="flex flex-1 items-center gap-0.5 overflow-hidden rounded-full bg-white/20 px-1.5 py-px">
        <svg
         viewBox="0 0 24 24"
         className="h-1.5 w-1.5 shrink-0 fill-white/80"
        >
      ...
      <div className="relative aspect-9/14 w-full overflow-hidden bg-gray-900">
       ...
       <div className="absolute right-1.5 top-1.5 flex items-center gap-1">
        <span className="animate-pulse rounded bg-red-600 px-1 py-px text-[6px] font-black text-white leading-tight">LIVE</span>
        <div className="flex items-center gap-0.5 rounded bg-black/50 px-1 py-px">
         <Field
          fields={fields}
       ...
       <div className="absolute right-1 top-1/3 flex flex-col items-center gap-1.5">
        {['❤️', '😮', '😢', '👍'].map((emoji) => (
         <span
          key={emoji}
          className="text-[10px] drop-shadow-[0_1px_3px_rgba(0,0,0,0.9)]"
         >
          {emoji}
         </span>
        ))}
       ...
       <div className="absolute inset-x-1.5 bottom-5 space-y-0.75">
        {comments.slice(0, 3).map((c, i) => (
         ...
         >
          ...
          <div className="flex items-baseline gap-1 rounded-full bg-black/40 px-1.5 py-px">
       ...
       {/* Comment input bar */}
       <div className="absolute inset-x-1.5 bottom-1 flex items-center gap-1 rounded-full bg-white/20 px-1.5 py-0.5 backdrop-blur-sm">
