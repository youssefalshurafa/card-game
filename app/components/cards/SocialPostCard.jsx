...
import { ChallengeHeader, Field, ImageField } from './utils';
...
export default function SocialPostCard({ card, fields, editable, onFieldChange }) {
 return (
  <div className="flex h-full flex-col overflow-hidden rounded-2xl bg-gradient-to-b from-[#7ab3a0] to-[#4e9080]">
   ...
   {/* Centered phone content with side margins */}
   <div className="flex flex-1 flex-col items-center px-4 py-3">
    <div className="flex w-full flex-col overflow-hidden rounded-xl border-[3px] border-slate-700 bg-white shadow-[0_8px_24px_rgba(0,0,0,0.4)]">
     {/* Status bar */}
     <div className="flex items-center justify-between bg-[#3b5998] px-3 py-[3px] text-[8px] text-white">
      <div className="flex items-center gap-1">
       <svg
        viewBox="0 0 16 10"
        className="h-[7px] w-[10px] fill-white"
       >
        <rect
         x="0"
         y="6"
     ...
     {/* Browser bar */}
     <div className="flex items-center gap-2 bg-[#3b5998] px-3 pb-[4px] pt-[2px]">
      <svg
       viewBox="0 0 24 24"
       className="h-[14px] w-[14px] shrink-0 fill-white"
      >
      ...
      <div className="flex flex-1 items-center gap-1 overflow-hidden rounded-full bg-white/20 px-2.5 py-[2px]">
       <svg
        viewBox="0 0 24 24"
        className="h-[8px] w-[8px] shrink-0 fill-white/80"
       >
     ...
     <div className="flex flex-1 flex-col bg-white">
      ...
      <Field
       ...
       editable={editable}
       onFieldChange={onFieldChange}
       className="px-3 pb-2 text-[9px] leading-relaxed text-gray-900"
       tag="p"
      />
      ...
      <div className="flex items-center divide-x divide-gray-200">
       <button className="flex flex-1 items-center justify-center gap-1 py-2">
        <svg
         viewBox="0 0 24 24"
         className="h-[12px] w-[12px] fill-gray-500"
        >
